...
map_key("n", "<leader>gd", lsp_buf.definition, { desc = "Go to definition" })
map_key("n", "<leader>gi", lsp_buf.implementation, { desc = "Go to implementation" })
map_key("n", "<leader>td", lsp_buf.type_definition, { desc = "Show type definition" })
map_key("n", "<leader>tr", lsp_buf.references, { desc = "Show references" })
